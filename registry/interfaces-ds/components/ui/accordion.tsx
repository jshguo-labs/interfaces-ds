...
function Accordion({
  ...
  return <AccordionPrimitive.Root data-slot="accordion" className="flex w-xl flex-col overflow-hidden border box-border bg-card text-card-foreground rounded-xl" {...props} />
}
